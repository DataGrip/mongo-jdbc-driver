...
public class NashornCollectionCommandsTest {
  private static final String TEST_DATA_PATH = "src/test/resources/test-data/collections";
  private static final String EXPECTED_TEST_DATA_PATH = "src/test/resources/expected-nashorn/collections";
  private static Connection connection;
  private final String testName;

  public NashornCollectionCommandsTest(String testName) {
  ...
  public static void before() throws SQLException {
    ...
    properties.setProperty(SCRIPT_ENGINE, NASHORN_SCRIPT_ENGINE);
