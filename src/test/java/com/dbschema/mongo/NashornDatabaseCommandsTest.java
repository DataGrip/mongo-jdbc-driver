...
public class NashornDatabaseCommandsTest {
  private static final String TEST_DATA_PATH = "src/test/resources/test-data/databases";
  private static final String EXPECTED_TEST_DATA_PATH = "src/test/resources/expected-nashorn/databases";
  private static Connection connection;
  private final String testName;

  public NashornDatabaseCommandsTest(String testName) {
