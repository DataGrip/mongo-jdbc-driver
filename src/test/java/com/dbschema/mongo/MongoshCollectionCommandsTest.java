...
public class MongoshCollectionCommandsTest {
  private static final String TEST_DATA_PATH = "src/test/resources/test-data/collections";
  private static final String EXPECTED_TEST_DATA_PATH = "src/test/resources/expected-mongosh/collections";
  private static Connection connection;
  private final String testName;

  public MongoshCollectionCommandsTest(String testName) {
