...
import com.nosql.resultSet.NoSqlArrayResultSet;
import com.nosql.schema.*;
 ...
 */
public class NoSqlDatabaseMetaData implements DatabaseMetaData
{
    private final NoSqlConnection con;
    ...
    public NoSqlDatabaseMetaData(NoSqlConnection con) {
        this.con = con;
    }
    ...
    private void exportColumnsRecursive(MetaCollection collection, NoSqlArrayResultSet result, MetaField field) {
    ...
    private void getExportedKeysRecursive(NoSqlArrayResultSet result, MetaCollection pkCollection, MetaCollection fromCollection, MetaField fromFiled) {
    ...
    private void getImportedKeysRecursive(NoSqlArrayResultSet result, MetaField fromFiled) {
