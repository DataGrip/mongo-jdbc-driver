...
import com.nosql.NoSqlPreparedStatement;
...
public class NoSqlArrayResultSet implements ResultSet
{
	...
	private NoSqlPreparedStatement statement = null;
	...
	public void setStatement(NoSqlPreparedStatement statement) {
	...
	public ResultSetMetaData getMetaData() throws SQLException
	{
		...
		return new NoSqlResultSetMetaData(tableName, columnNames, columnJavaTypes, columnDisplaySizes);
	}
