...
public class NoSqlResultSetMetaData implements ResultSetMetaData
{
	...
	public NoSqlResultSetMetaData(String tableName, String[] columnNames, int[] javaTypes, int[] displaySizes)
	{
