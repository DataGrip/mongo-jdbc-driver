...
public class NoSqlConnection implements Connection
{
	...
	public NoSqlConnection( Service service) throws UnknownHostException {
	...
	public Statement createStatement() throws SQLException {
		checkClosed();
		return new NoSqlPreparedStatement(this);
	}
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		checkClosed();
        return new NoSqlPreparedStatement(this, sql );
	}
    ...
    private final NoSqlDatabaseMetaData metaData = new NoSqlDatabaseMetaData(this);
