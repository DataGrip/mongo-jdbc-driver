...
import com.nosql.mongo.JMongoCollection;
import com.nosql.mongo.JMongoDatabase;
import com.nosql.mongo.MongoService;
import com.nosql.resultSet.NoSqlAggregateResultSet;
import com.nosql.resultSet.NoSqlArrayResultSet;
import com.nosql.resultSet.NoSqlIteratorResultSet;
import com.nosql.resultSet.NoSqlOkResultSet;
...
public class NoSqlPreparedStatement implements PreparedStatement {
    ...
    public NoSqlPreparedStatement(final NoSqlConnection con) {
        this.con = con;
        this.sql = null;
    }

    public NoSqlPreparedStatement(final NoSqlConnection con, String sql) {
        this.con = con;
        this.sql = sql;
    }
